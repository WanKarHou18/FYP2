...
public class PrinterViewReceivedSubOrderDetailsActivity extends AppCompatActivity implements View.OnClickListener {

    //View
    private View root;
    private TextView tv_FileName_display_PVSODA;
    private TextView tv_fileType_PVSODA;
    private ListView lv_subOrderPrintPref_PVSODA;
    private TextView tv_cost_PVSODA;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_printer_home_main);
    ...
    private void linkXML() {
        tv_FileName_display_PVSODA = findViewById(R.id.tv_FileName_display_PVSODA);
        tv_fileType_PVSODA= findViewById(R.id.tv_fileType_PVSODA);
        lv_subOrderPrintPref_PVSODA= findViewById(R.id.lv_subOrderPrintPref_PVSODA);
        tv_cost_PVSODA= findViewById(R.id.tv_cost_PVSODA2);
    }
    ...
    private void createLayoutView() {
        tv_FileName_display_PVSODA.setText(sub_order.getResourcesRecord().getfile_name());
        tv_fileType_PVSODA.setText(sub_order.getResourcesRecord().getFile_type());
        tv_cost_PVSODA.setText(sub_order.getCost());
    ...
    private void handleLayout() {
        ...
        lv_subOrderPrintPref_PVSODA.setAdapter(listViewAdapter);
